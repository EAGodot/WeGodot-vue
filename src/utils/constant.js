...
export default {
  ...
  baseURL: "http://localhost:8000/api",
  webURL: "http://localhost:8000",
  // baseURL: "http://www.monkey-papa.com/api", // ���ϵ�ַ����/api
  // webURL: "http://www.monkey-papa.com",  // ���ϵ�ַ

  //qiniuUploadImages: "http://www.monkey-papa.com/api/resource/updateImage/", // ��ĺ�����ϵ�ַ����/api/resource/updateImage/
  qiniuUploadImages: "http://localhost:8000/api/resource/updateImage/", // ��ĺ�����ϵ�ַ����/api/resource/updateImage/

  //qiniuUploadEntrance: "http://www.monkey-papa.com/", // �����ţ�ƴ洢�ռ����������
  qiniuUploadEntrance: "http://localhost:8000/", // �����ţ�ƴ洢�ռ����������
  */
