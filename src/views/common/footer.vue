    ...
    <div id="footer_icons">
      <div>
        <a
          ...
          target="_blank"
          rel="noopener"
          href="https://5d0e809a.r25.cpolar.top/"
          title="个人主页"
        >
        ...
        <a
          @click="copy(2)"
          class="icon_link contact-wechat"
          href="javascript:;"
          title="联系微信"
          data-pjax-state=""
        >
      ...
      <img
        ...
        data-lazy-src="../../../public/title.jpg"
      ...
      <div class="footer-bottom-content">
        ...
        <div class="footer-bottom-right">
          ...
          <div>
            ...
            <!--
            <a class="footer-bottom-link" href="javascript:;" title="备案号"
              >京cpu备5201314号</a
            >
            -->
...
export default {
  data() {
    return {
      countdownTime: "2025-12-1 00:00:00",
      countdownChange: "",
    };
  },
  mounted() {
